...
export const CURATED_OFFERS: DiscoveredOffer[] = [
  ...
  },
  {
    ...
    accountOpeningUrl: "https://www.pnc.com/en/personal-banking/banking/checking.html",
    applicationUrl: "https://www.pnc.com/en/personal-banking/banking/checking.html",
    applicationChannel: "web",
    ...
    payoutWindowDays: 90,
    newCustomerRequired: true,
    termsUrl: "https://www.pnc.com/en/personal-banking/banking/checking.html",
  ...
  },
  {
    ...
    productType: "checking",
    monthlyFeeCents: 0,
    accountOpeningUrl: "https://www.key.com/personal/checking/checking-accounts-options.html",
    applicationUrl: "https://www.key.com/personal/checking/checking-accounts-options.html",
    applicationChannel: "web",
    ...
    requirementWindowDays: 90,
    newCustomerRequired: true,
    termsUrl: "https://www.key.com/personal/checking/checking-accounts-options.html",
    sourceUrl: DOC,
  ...
  },
  {
    ...
    productType: "checking",
    monthlyFeeCents: 0,
    accountOpeningUrl: "https://www.mtb.com/personal/checking-accounts",
    applicationUrl: "https://www.mtb.com/personal/checking-accounts",
    applicationChannel: "web",
    ...
    requirementWindowDays: 90,
    newCustomerRequired: true,
    termsUrl: "https://www.mtb.com/personal/checking-accounts",
    sourceUrl: DOC,
    extractionConfidence: 0.7,
    verificationStatus: "llm_verified",
    requirements: [
  ...
  // ---- Business checking bonuses (audience: business) ----
  // Business bonuses pay far more than consumer ones but require a KYB payload
  // (EIN, entity type, formation details) and larger qualifying deposits. These
  // surface only behind the `business_accounts` feature flag. Amounts are the
  // publicly advertised tiers; confirm the exact tier/qualifying activity at the
  // source before acting. Nothing here is financial advice.
  {
    brandName: "Chase",
    legalName: "JPMorgan Chase Bank, N.A.",
    charterType: "national_bank",
    ...
    chexsystemsSensitivity: "strict",
    earlyClosureClawbackDays: 180,
    productName: "Chase Business Complete Banking",
    productType: "business_checking",
    monthlyFeeCents: c(15),
    minOpeningDepositCents: 0,
    accountOpeningUrl: "https://www.chase.com/business/banking/checking/complete-banking",
    applicationUrl: "https://www.chase.com/business/banking/checking/complete-banking",
    applicationChannel: "web",
    audience: "business",
    signupNotes:
      "Deposit $2,000 in new money within 30 days and maintain it for 60 days, plus 5 qualifying transactions. You'll need your EIN, business formation date, and entity type at signup.",
    title: "Chase Business Complete Banking — $300 bonus",
    offerCode: "coupon",
    bonusType: "cash",
    bonusAmountCents: c(300),
    offerEndDate: "2026-10-16",
    requirementWindowDays: 60,
    payoutWindowDays: 30,
    newCustomerRequired: true,
    customerLookbackMonths: 12,
    termsUrl: "https://www.chase.com/business/banking/checking/complete-banking",
    sourceUrl: "https://www.doctorofcredit.com/chase-business-complete-banking-300-bonus/",
    ...
    disqualifiers: [
      {
        disqualifierType: "existing_customer",
        lookbackMonths: 12,
        detail: "Not for existing Chase business checking customers.",
      },
    ],
  },
  {
    ...
    chexsystemsSensitivity: "moderate",
    earlyClosureClawbackDays: 180,
    productName: "U.S. Bank Business Checking",
    productType: "business_checking",
    monthlyFeeCents: c(0),
    minOpeningDepositCents: c(100),
    accountOpeningUrl: "https://www.usbank.com/business-banking/banking-products/business-bank-accounts/business-checking-account.html",
    applicationUrl: "https://www.usbank.com/business-banking/banking-products/business-bank-accounts/business-checking-account.html",
    applicationChannel: "web",
    audience: "business",
    signupNotes:
      "Open a Silver Business Checking, enroll in online banking, and deposit $5,000 within 30 days, keeping it 60 days. EIN and business documents required at signup.",
    title: "U.S. Bank Business Checking — $800 bonus",
    offerCode: "Q4BIZ",
    bonusType: "cash",
    bonusAmountCents: c(800),
    offerEndDate: "2026-09-30",
    requirementWindowDays: 60,
    payoutWindowDays: 30,
    newCustomerRequired: true,
    customerLookbackMonths: 12,
    termsUrl: "https://www.usbank.com/business-banking/banking-products/business-bank-accounts/business-checking-account.html",
    sourceUrl: "https://www.doctorofcredit.com/us-bank-business-checking-bonus/",
    extractionConfidence: 0.82,
    verificationStatus: "llm_verified",
    requirements: [
      {
    ...
    disqualifiers: [
      {
        disqualifierType: "existing_customer",
        lookbackMonths: 12,
        detail: "New U.S. Bank business checking customers only.",
      },
    ],
  },
  {
    ...
    chexsystemsSensitivity: "moderate",
    earlyClosureClawbackDays: 180,
    productName: "PNC Business Checking",
    productType: "business_checking",
    monthlyFeeCents: c(12),
    minOpeningDepositCents: c(100),
    accountOpeningUrl: "https://www.pnc.com/en/small-business/banking/business-checking-overview.html",
    applicationUrl: "https://www.pnc.com/en/small-business/banking/business-checking-overview.html",
    applicationChannel: "web",
    audience: "business",
    signupNotes:
      "Open online, then complete qualifying deposit + transaction activity within 60 days. Have your EIN, entity type, and formation state ready.",
    title: "PNC Business Checking — $400 bonus",
    offerCode: "BIZ400",
    bonusType: "cash",
    bonusAmountCents: c(400),
    offerEndDate: "2026-11-30",
    requirementWindowDays: 60,
    payoutWindowDays: 30,
    newCustomerRequired: true,
    customerLookbackMonths: 12,
    termsUrl: "https://www.pnc.com/en/small-business/banking/business-checking-overview.html",
    sourceUrl: DOC,
    extractionConfidence: 0.7,
    verificationStatus: "llm_verified",
    requirements: [
    ...
    disqualifiers: [
      {
        disqualifierType: "existing_customer",
        lookbackMonths: 12,
        detail: "New PNC business checking customers only.",
      },
    ],
  },
];
